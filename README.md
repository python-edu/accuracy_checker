...
## Manual installation
To install the script manually you can:

  - download the latest version of the script from the `wheels` directory (`accuracy-latest-0.0.0-py3-none-any.whl`),
  - or use the `RAW URL` address directly.

Below is a list of script installation steps:
   ...
   ```bash
      ...
      python -m pip install accuracy-3.0.0-py3-none-any.whl

      #  - or using RAW URL
      python -m pip install https://raw.githubusercontent.com/python-edu/accuracy_checker/main/wheels/accuracy-3.0.0-py3-none-any.whl
   ```
